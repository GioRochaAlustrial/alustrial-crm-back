...
//     }
// }
import { listNotificacionesByUser, markNotificacionLeida, markNotificacionLeidaById } from "../repositories/notificaciones.repo.js";
...
export async function leerNotificacion(req, res) {
    try {
        ...
        const updated = await markNotificacionLeidaById({
            id_usuario,
            id_notificacion: id,
        });
